  ...
  return (
    <Card>
      ...
      <Text>
        ...
        requirements, skill matching, and availability. Simply input your query
        in the chat to analyze engineer skills, project needs, and time-off
        schedules. Ask questions like "Which engineers are available for Project
        X?" or "Who has the required skills for our upcoming cloud migration?"
        to receive data-driven recommendations for resource allocation and team
        planning.
      </Text>
      <Tabs
                    ...
                    <Flex direction="row" gap="1rem" alignItems="flex-start">
                      ...
                      <Flex direction="column" gap="0.5rem" flex="1">
                        ...
                        >
                          ...
                          <Badge
                            variation={
                              engineer.availability ? "success" : "error"
                            }
                          >
                    ...
                    >
                      <Flex direction="column" gap="0.5rem">
                        <Text variation="primary" fontWeight="bold">
                          {
                            engineers.find(
                              (e: Engineer) => e.id === vacation.engineerId
                            )?.name
                          }
                        </Text>
                      </Flex>
                      <Badge variation="info">{vacation.type}</Badge>
                    </Flex>
                    <Text variation="secondary">
